...
A substantial part of these debates focuses on whether they are robust or fundamental enough to be worthy of philosophers' attention as compared to axiomatized approaches---which, to Williams' mind---still are in the focus of philosophical orthodoxy. 
Williams' `effective realism' about EFT is certainly one way to justify the value of EFTs. 
A kind of pragmatic or instrumentalist view was developed, initially by \citet{huggetweingard}, in response to the controversial views of \citet{cao1993}, whereby EFTs are merely tools for extending the scope of physics. 
...
With considerable foresight, Grinbaum suggest that ``perhaps something like this is happening today with EFT and the model-independent analysis of new physics.''
Indeed, today, physicists are unsure whether Supersymmetry, extra-dimensions, or some other model will be the next accepted theory and once again we find them turning to the pragmatic benefits of EFTs. 

But we have to note that he and most of the authors have focused on EFTs in general and not specifically on the bottom-up approach of the SM-EFT.
