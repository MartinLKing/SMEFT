...
expected.
We consider this as not being a
useful concept for an experimental target. 
Thus, the stage 1 SM-EFT just serves as a tool to potentially parametrize, in general
constrain the size of possible deviations from the SM. 
% which are consistent with the underlying assumptions of the SM-EFT. 

The \emph{Stage 2} of the bottom-up approach is an operational response
...
An EFT analysis obtains a target and representational values, 
...
We refer to it as \emph{Stage 3} EFT.  
...
The major difference between stages 1 and partly stage 2 versus stage 3 is the (absence)
...
The roles of target, prediction and testability and representation is therefore
...
(B denoting the baryon number, L the lepton number), as conceived in GUTs in mind.
...
10$^{14}$ GeV, suggesting by the merging of the electromagnetic, weak and strong couplings, 
...
While one certainly can look for any kind of deviation the SM-EFT allows, something
that anyhow is in the spirit of expecting BSM somewhere,
...
We thus diagnose a change between stage 1 and 2, versus stage 3 
in major properties that will be relevant for the further qualifications in models.
